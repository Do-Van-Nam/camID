class ApiEndPoint {
  ...
  static String DOMAIN_API_GATEWAY = "https://apigw.camid.app:8423/ApiGateway/CoreService";
  ...
  static String API_GET_USER_INFO = "$DOMAIN/camid-auth/api/v1/user/get-user-v2";
  static String API_USER_ROUTING = "$DOMAIN_API_GATEWAY/UserRouting";
  static String API_UPDATE_AVATAR = "$DOMAIN/camid-auth/api/v1/user/update-avatar";
}